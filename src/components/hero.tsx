...
const Hero = () => {
  return (
    <section id="hero">
      <div className="container flex flex-col items-center content-center justify-center text-center text-darkBlue mx-auto mt-12 h-screen">
        <img
          className="max-w-64 max-h-64 mt-0 bg-lightGold rounded-bl-lg"
          src={portrait}
          alt="potrait"
        />

        <h1
          className="py-8 max-w-md text-6xl font-bold text-center md:text-5xl md:text-left text-darkBlue 
